const ORA_ABS_X = 0x1D;
const ORA_IND_X = 0x01;
const STA_IND_X = 0x81;
const JSR_ABS = 0x20;
const LDX = 0xA2;
const JMP = 0x4C;
const STX = 0x86;
...
const ORA_ZP_X = 0x15;
const ASL_ZP_X = 0x16;
const AND_IND_X = 0x21;
const AND_IND_Y = 0x31;
const AND_ZP = 0x25;
const ROL_ZP = 0x26;
const PLP = 0x28;
const AND_IMM = 0x29;
...
op_table[129] = 'STA_IND_X';
op_table[1] = 'ORA_IND_X';
op_table[132] = 'STY_ZP';
op_table[133] = 'STA_ZP';
op_table[134] = 'STX_ZP';
op_table[136] = 'DEY';
...
op_table[32] = 'JSR_ABS';
op_table[186] = 'TSX';
op_table[29] = 'ORA_ABS_X';

module.exports = {op_table, LDX,JMP,STX,SEC,BCS,CLC,LDA_ZP,BEQ,BNE,BIT,BVS,BVC,BPL,BRK,ORA_I,ORA_ZP,ASL_ZP,PHP,ORA_IMM,ASL_A,ORA_ABS,ORA_IY,ORA_ZP_X,ASL_ZP_X,AND_IND_X,AND_ZP,ROL_ZP,PLP,AND_IMM,ROL_ABS,BMI,AND_IY,AND_ZP_X,ROL_ZP_X,AND_ABS_Y,AND_ABS_X,ROL_ABS_X,RTI,EOR_IND_X,EOR_ZP,LSR_ZP,PHA,EOR_IMM,LSR_A,EOR_ABS,LSR_ABS,EOR_IY,EOR_ZP_X,LSR_ZP_X,EOR_ABS_Y,EOR_ABS_X,LSR_ABS_X,RTS,ADC_IX,ADC_ZP,ROR_ZP,PLA,ADC_IMM,ROR_A,JMP_I,ADC_ABS,ROR_ABS,ADC_IY,ADC_ZP_X,ROR_ZP_X,SEI,ADC_ABS_Y,ADC_ABS_X,ROR_ABS_X,STA_IX,STY_ZP,STA_ZP,STX_ZP,DEY,TXA,STY_ABS,STA_ABS,STX_ABS,BCC,STA_IY,STY_ZP_X,STA_ZP_X,STX_ZP_Y,TYA,STA_ABS_Y,TXS,STA,LDY_IMM,LDA_IND_X,LDX_IMM,TAY,LDA_IMM,TAX,LDY_ABS,LDA_ABS,LDX_ABS,LDA_IY,LDY_ZP_X,LDA_ZP_X,LDX_ZP_Y,CLV,LDA_ABS_Y,LDY_ABS_X,LDA_ABS_X,LDX_ABS_Y,CPY_IMM,CMP_IX,CPY_ZP,DEC_ZP,INY,CMP_IMM,DEX,CPY_ABS,CMP_ABS,DEC_ABS,CMP_IY,CMP_ZP_X,DEC_ZP_X,CLD,CMP_ABS_Y,CMP_ABS_X,DEC_ABS_X,CPX_IMM,SBC_IX,CPX_ZP,SBC_ZP,INC_ZP,SBC_IMM,NOP,CPX_ABS,SBC_ABS,INC_ABS,SBC_IY,SBC_ZP_X,INC_ZP_X,SED,SBC_ABS_Y,SBC_ABS_X,INC_ABS_X, INX, TSX, ROL_A, LDA_ZP, JSR_ABS, EOR_IND_Y, STA_IND_X, ORA_IND_X, ORA_ABS_X}

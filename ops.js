...
var operations = {
  ...
  BCS: function() {
    ...
    this.log(
      "BCS " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
  ...
  PLP: function() {
    ...
    this.cycles -= 4;
    this.registers.SP++;
    let t = ("00000000" + pflags.toString(2)).substr(-8).split("").map((n) => parseInt(n)).reverse();
  ...
  BCC: function() {
    ...
    this.log(
      "BCC " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
  ...
  BEQ: function() {
    this.log(
      "BEQ " + (this.next_byte() + this.registers.PC).toString(16),
      this.registers.PC
    );
  ...
  BNE: function() {
    this.log(
      "BNE " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
  ...
  BVS: function() {
    ...
    this.log(
      "BVS " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
    this.registers.PC += 2;
  ...
  BVC: function() {
    ...
    this.log(
      "BVC " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
    this.registers.PC += 2;
  ...
  BPL: function() {
    ...
    this.log(
      "BPL " + (this.next_byte() + this.registers.PC + 2).toString(16),
      this.registers.PC
    );
...
/*    if (utility.bit(byte, 1) == 1) {
  ...
  AND_IND_Y: function() {
    this.registers.A =
      this.registers.A & this.fetch(this.next_byte() + this.registers.Y);
    this.log("AND (" + this.next_byte() + "), X", this.registers.PC);
  },
  ADC_IMM: function() {
    let result =
  ...
  ORA_ABS_X: function() {
    ...
    this.registers.A =
      this.registers.A | (this.next_bytes() + this.registers.X);
    this.cycles -= 2;
    if (this.registers.A == 0) {
      this.flags.zero = true;
    }
  ...
  ORA_IND_X: function() {
    this.log(
      "ORA (" + this.fetch(this.next_byte()) + "), X",
      this.registers.PC
    );
    this.registers.A =
      this.registers.A | this.fetch(this.next_byte() + this.registers.X);
  ...
  ORA_IND_Y: function() {
    this.log(
      "ORA (" + this.fetch(this.next_byte()) + "), Y",
      this.registers.PC
    );
    this.registers.A =
      this.registers.A | this.fetch(this.next_byte() + this.registers.Y);
  ...
  EOR_ABS_X: function() {
    this.registers.A =
      this.registers.A ^ this.fetch(this.next_bytes() + this.registers.X);
    this.cycles -= 4;
    if (this.registers.A == 0) {
      this.flags.zero = true;
    }
  ...
  EOR_ABS_Y: function() {
    this.registers.A =
      this.registers.A ^ this.fetch(this.next_bytes() + this.registers.Y);
    this.cycles -= 4;
    if (this.registers.A == 0) {
      this.flags.zero = true;
    }
